...
class StatutoryAprovalA7 extends StatefulWidget {
  ...
  @override
  _StatutoryAprovalA7State createState() => _StatutoryAprovalA7State();
}

class _StatutoryAprovalA7State extends State<StatutoryAprovalA7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          text: 'Key Events / ${widget.depoName!} /A7',
